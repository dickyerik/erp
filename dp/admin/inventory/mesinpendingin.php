...
$barang = query("SELECT * FROM barang WHERE kategori = 'Mesin Pendingin'");
?>
...
<body>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th scope="row">
                                        ...
                                        <hr>
                                        <a href="tambahmaintenancehistory.php?id=<?= $brg["id"]; ?>">Tambah Data</a>
                                    </th>
                                </tr>
                            </tbody>
                            <?php $no++; ?>
    ...
    <script src="../js/scriptmesinpendingin.js"></script>
</body>
