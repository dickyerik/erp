...
$barang = query("SELECT * FROM barang WHERE kategori = 'Chinaware'");
                ...
                <div id="container">
                    <table class="table table-bordered table-hover">
                        <thead class="thead-light sticky-top">
                            <tr>
                                <th scope="col">No</th>
                                <th scope="col" class="no">Edit</th>
                                <th scope="col">Nama Barang</th>
                                <th scope="col">Photo</th>
                                <th scope="col">Qty</th>
                                <th scope="col">Satuan</th>
                                <th scope="col" class="no">Update Qty</th>
                                <th scope="col" class="no">SKU</th>
                                <th scope="col" class="on">SO Qty</th>
                            </tr>
                        </thead>
                        <?php $no = 1; ?>
