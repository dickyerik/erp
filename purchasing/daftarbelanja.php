...
$barang = query("SELECT invoiceId, createdDate, harga, qty, pic, client.namaPerusahaan, masterasset.namaAsset FROM daftarbelanja INNER JOIN client ON client.clientId = daftarbelanja.clientId INNER JOIN masterasset ON masterasset.assetId = daftarbelanja.assetId");
            ...
            <?php foreach ($barang as $brg) : ?>
                <tbody>
                    <tr>
                        ...
                        <td><?= $brg["createdDate"]; ?></td>
                        <td><?= $brg["namaPerusahaan"]; ?></td>
                        <td><?= $brg["namaAsset"]; ?></td>
                        <td><?= $brg["harga"]; ?></td>
                        <td><?= $brg["qty"]; ?></td>
                    </tr>
