...
function tambahdatabelanja($data)
{
    global $conn;

    $invoiceId = htmlspecialchars($data["invoiceId"]);
    $createdDate = htmlspecialchars($data["createdDate"]);
    $clientId = htmlspecialchars($data["clientId"]);
    $assetId = htmlspecialchars($data["assetId"]);
    $harga = htmlspecialchars($data["harga"]);
    $qty = htmlspecialchars($data["qty"]);
    $pic = htmlspecialchars($data["pic"]);

    $query = "INSERT INTO daftarbelanja VALUES('$invoiceId','$createdDate','$clientId','$assetId','$harga','$qty','$pic')";
